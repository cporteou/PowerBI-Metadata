...
.EXAMPLE
Get-Datasets -authToken $auth
Get-Datasets -authToken $auth -workspaceID 1530055f-XXXX-XXXX-XXXX-ee8c87e4a648
Get-Datasets -authToken $auth -workspaceName 'Workspace Name'
