...
.EXAMPLE
Get-WorkspaceUsers -authToken $auth
Get-WorkspaceUsers -authToken $auth -workspaceID 1530055f-XXXX-XXXX-XXXX-ee8c87e4a648
Get-WorkspaceUsers -authToken $auth -workspaceName 'Workspace Name'
